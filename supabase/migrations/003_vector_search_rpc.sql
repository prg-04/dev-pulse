-- Vector similarity search RPC functions for tutorial search
-- Used by POST /api/tutorial-search for two-stage chapter-first / chunk-fallback search
-- Cosine distance threshold: 0.5 (similarity > 0.5). Tune after real data review.

-- Stage 1: search tutorial_chapters.label_embedding restricted to a set of video_ids
...
-- Stage 2: search tutorial_chunks.embedding filtered by skill_tag
